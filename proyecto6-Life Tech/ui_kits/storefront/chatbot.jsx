...
function ChatBotPanel({ onClose }) {
  ...
  const windowStyle = {
    ...
    boxShadow: "0 32px 80px rgba(0,0,0,0.8), 0 0 0 1px rgba(34,211,238,0.06)",
    display: "flex",
    ...
    <>
      ...
      <div style={windowStyle}>
        ...
        <div style={{
          ...
          background: "linear-gradient(135deg, #111116, #17171f)",
          flexShrink: 0,
        }}>
          <div style={{
        ...
        {/* Input */}
        <div style={{ padding: "12px 16px", borderTop: "1px solid rgba(255,255,255,0.07)", display: "flex", gap: 8, flexShrink: 0, background: "#0e0e12" }}>
        ...
        {/* Footer */}
        <div style={{ padding: "6px 16px 12px", textAlign: "center", flexShrink: 0 }}>
